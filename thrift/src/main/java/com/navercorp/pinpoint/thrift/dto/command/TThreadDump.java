...
public class TThreadDump implements org.apache.thrift.TBase<TThreadDump, TThreadDump._Fields>, java.io.Serializable, Cloneable, Comparable<TThreadDump> {
  ...
  public TThreadDump(TThreadDump other) {
    ...
    if (other.isSetStackTrace()) {
      List<String> __this__stackTrace = new ArrayList<String>(other.stackTrace);
      this.stackTrace = __this__stackTrace;
    }
    if (other.isSetLockedMonitors()) {
      List<TMonitorInfo> __this__lockedMonitors = new ArrayList<TMonitorInfo>(other.lockedMonitors.size());
    ...
    if (other.isSetLockedSynchronizers()) {
      List<String> __this__lockedSynchronizers = new ArrayList<String>(other.lockedSynchronizers);
  ...
  public int hashCode() {
    ...
    if (present_blockedTime)
      list.add(blockedTime);
    ...
    if (present_waitedTime)
      list.add(waitedTime);

    boolean present_waitedCount = true;
    list.add(present_waitedCount);
    if (present_waitedCount)
      list.add(waitedCount);
    ...
    if (present_lockOwnerId)
      list.add(lockOwnerId);

    boolean present_lockOwnerName = true && (isSetLockOwnerName());
    list.add(present_lockOwnerName);
    if (present_lockOwnerName)
      list.add(lockOwnerName);
    ...
    if (present_lockedMonitors)
      list.add(lockedMonitors);

    boolean present_lockedSynchronizers = true && (isSetLockedSynchronizers());
    list.add(present_lockedSynchronizers);
    if (present_lockedSynchronizers)
      list.add(lockedSynchronizers);
